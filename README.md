...
- To systematically identify HGT events driven by FMT, we developed HGTscreener, a computational framework that integrates metagenomic assembly, homology search, phylogenetic assignment, and functional annotation (as shown above). 
...
- For user who attempt to process long-reads sequencing data (e.g. PacBio type) by HGTscreener, please revise __"./root.sh"__ in line 253 of HGT_main_implementing.sh as "./root1.sh";

- Please feel free to contact us via Chen2422679942@163.com (__Dr. CHEN Sizhe__) and we are willing to provide necessary assistance for implementing HGTscreener.

### A Preliminary Step-by-step Guideline and Example

- The content below is an example for appropriately using HGTscreener. Assuming in your initial path, you have 3 different directories named as __"FMT_HGT"__, __"tax"__, and __"reference_data_base"__, as shown below:
...
- After all basic files prepared as aforementioned, we can start to use HGTscreener directly.
