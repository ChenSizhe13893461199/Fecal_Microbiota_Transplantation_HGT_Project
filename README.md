...
For user who attempt to process long-reads sequencing data (e.g. PacBio type) by HGTector, please revise "./root.sh" in line 231 of HGT_main_implementing.sh as "./root1.sh"
