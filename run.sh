...
for i in "${!pre_samples[@]}"; do
    ...
    # The following script "blastn_process.py" was used to generate summary of alignment, in which -t (e.g. 0.9 represents at least 90% of full length) controls the filtering threshold for the ratio of alignment length
